let palabras = ['ANGEL','BOLETA','PEPINO','DESTINO','PAN','HTML','PALESTRA','LETRAS','PUPILA','COSTUMBRE','GLANDULA','ELEGANTE','FENOMENO','GLORIA','JUVENTUD','MODERNO','OMBLIGO','PEDESTAL','MANTRA','RUMEANTE','SOLTAR','RUECA','PASTEL','LIMBO','AGRADO','PROGRAMA','FRACTAL','VAQUERO','ZEBRA','DATOS','ESPIRAL','MODAL','ESPIRITU','FRACCION','ZOMBIE','BAILE','SUTURA','SALPICAR','APLOMO','MERITO'];
let palabraSecreta = "";
let nuevaPalabra = "";
let numeroErrores = 0; 
